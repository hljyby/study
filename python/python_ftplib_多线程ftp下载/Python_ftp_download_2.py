...
def downLoad(ftp, fileSet, localpath):
    ...
    for dir in fileSet:
        ...
        for fileName in dir.get('fileList'):
            ...
            # executor.submit(ftpDownloadFile, ftp=ftp, ftpfile=fileName,
            #                 localfile=dir.get("localPath"), ftpPath=ftpPath)

            ftpDownloadFile(ftp=ftp, ftpfile=fileName,
                            localfile=dir.get("localPath"), ftpPath=ftpPath)
